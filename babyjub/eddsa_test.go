...
func TestSignVerifyPoseidon(t *testing.T) {
	...
	pk := k.Public()
	assert.Equal(t,
		"21778400570239116728348365745543297004362844107770678832137707832263215031974",
		pk.X.String())
	assert.Equal(t,
		"3424485431756416461212797600568837006616965670928311552549314309487838917189",
		pk.Y.String())
	...
	assert.Equal(t,
		...
		sig.R8.Y.String())
	assert.Equal(t,
		"254344842908290665875580114772700984865727383064138372447675063120756439931",
		sig.S.String())
